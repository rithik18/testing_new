...
const Contact = () => {
  return (
    <section className="bg-white m-6 dark:bg-gray-900">
  <div className="py-3 lg:py-7 px-4 mx-auto max-w-screen-sm border rounded-md">
    ...
    <form action="#" className="space-y-8">
      ...
      <div className="sm:col-span-2">
        ...
        <textarea
          ...
          className="block resize-none p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
